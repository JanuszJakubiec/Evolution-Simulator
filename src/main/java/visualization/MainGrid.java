...
public class MainGrid extends GridPane {
  ...
  {
    file = new FileParser();
    Simulation simulation1 = new Simulation(file.width, file.height, file.jungleRatio, file.numberOfAnimals, file.animalStartEnergy, file.grassIncome, file.dayCost);
  ...
  {
    Simulation simulation2 = new Simulation(file.width, file.height, file.jungleRatio, file.numberOfAnimals, file.animalStartEnergy, file.grassIncome, file.dayCost);
