...
class AnimalTest {
  ...
  void checkDayOfDeathIfAlive() {
    Animal animal = new Animal(new WorldMap(5,5,0.5), 6, 5, new Vector2d(0,0));
    assertEquals(-1,animal.getDayOfDeath());
  }
  ...
  @Test
  void getDayOfBirth() {
    Animal animal = new Animal(new WorldMap(5,5,0.5), 5, 5, new Vector2d(0,0));
  ...
  void checkIfAnimalDNAHasCorrectLengthAfterMating() {
    Animal parent1 = new Animal(new WorldMap(5,5,0.5), 5, 5, new Vector2d(0,0));
    Animal parent2 = new Animal(new WorldMap(5,5,0.5), 5, 5, new Vector2d(0,0));
  ...
  void checkIfAnimalMovesProperly() {
    Animal animal = new Animal(new WorldMap(2,2,0.5), 5, 8, new Vector2d(0,0));
    animal.move();
